...
/**
    ...
    public void _1_anObservableStreamOfEventsAndDataEmitsEachItemInOrder() {
        ...
        // In RxJava2 each observable has a method test which returns a TestObservable
        // that can be used in assertions. When working with Flowable a TestSubscriber
        // will be returned.
        final TestObserver<String> testObserver = pipelineOfData.test();

        // To get all values emitted by Observable
...
/**
    ...
    public void _3_justCreatesAnObservableEmittingItsArguments() {
        ...
        final Observable<Object> stoogeDataObservable = Observable.just(stoogeOne, stoogeTwo, stoogeThree, stoogeAge);
